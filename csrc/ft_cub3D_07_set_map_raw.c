...
/*   Updated: 2025/04/23 19:18:28 by rponomar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_malloc_raw_map(t_tr *t)
{
	...
	if (!t->f_map_raw)
	{
		t->f_map_raw = malloc(sizeof(char *) * (t->map_raw_rows + 1));
...
static void	ft_passby_zero_one_player(char **k, char *entry, t_tr *t)
{
	if (t->map_invalid)
		return ;
	while (**k == '0' || **k == '1' \
